...
def processRequest(req):
    ...
    if (intent=='Course_Selection'):
        ...
        fulfillmentText="We have sent the course syllabus and the other relevant details to your email. An email has also been sent to the support team with your contact information, you will be contacted soon...Do you have any further queries?"
